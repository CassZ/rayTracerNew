...
public:
	...
	enum{Sig, Diffuse, Phong, Other, Texture};
...
int _mode;
bool anti_alising = true;
const int anti_alising_depth = 128;
bool glossy = false;
const float glossy_sampling_times = 80.0;
const int blur = 16;
const double blurdgr = 0.01;

unsigned long int texture_image_width;
long int texture_image_height;
char texture_image_name[] = "a.bmp";
unsigned char* texture_rbuffer;
unsigned char* texture_gbuffer;
unsigned char* texture_bbuffer;
