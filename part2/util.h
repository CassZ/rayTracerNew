...
struct Material {
	...
	double trans, double specialColor, bool texture, double refra_index) :
		ambient(ambient), diffuse(diffuse), specular(specular), 
		specular_exp(exp) , reflectivity(ref), transparency(trans), specialColor(specialColor), texture(texture),refra_index(refra_index) {}
